...
class DivisionsControllerTest < ActionController::TestCase
  ...
  test "should create division" do
    assert_difference('Division.count') do
      post :create, division: { created_at: @division.created_at, name: @division.name, updated_at: @division.updated_at }
    end
  ...
  test "should update division" do
    patch :update, id: @division, division: { created_at: @division.created_at, name: @division.name, updated_at: @division.updated_at }
    assert_redirected_to division_path(assigns(:division))
  end
