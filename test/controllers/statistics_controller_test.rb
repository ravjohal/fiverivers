...
class StatisticsControllerTest < ActionController::TestCase
  ...
  test "should create statistic" do
    assert_difference('Statistic.count') do
      post :create, statistic: { created_at: @statistic.created_at, name: @statistic.name, updated_at: @statistic.updated_at }
    end
  ...
  test "should update statistic" do
    patch :update, id: @statistic, statistic: { created_at: @statistic.created_at, name: @statistic.name, updated_at: @statistic.updated_at }
    assert_redirected_to statistic_path(assigns(:statistic))
  end
