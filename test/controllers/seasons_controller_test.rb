...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { created_at: @season.created_at, name: @season.name, updated_at: @season.updated_at, year: @season.year }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { created_at: @season.created_at, name: @season.name, updated_at: @season.updated_at, year: @season.year }
    assert_redirected_to season_path(assigns(:season))
  end
